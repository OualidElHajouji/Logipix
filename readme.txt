...
The rules of the game are explained in the file Logipix_explainer.png.

The different versions of the solvers are solvev1, solvev2, solvev3, solveWithCombination.
They are methods that can be run this way : puzzle.solve(), puzzle being from the class Logipix (created like this : puzzle = new Logipix() )
